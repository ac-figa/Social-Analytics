...
one Video_ID. Writes to youtube_classifications, which the pipeline reads
and reattaches to YouTube_Master on every refresh.

Usage:
  python -m src.classify --video-id dQw4w9WgXcQ --partnership "Caffe Borbone" --content-type "Sponsored Integration"
"""
import argparse
import sys
...
def main() -> int:
    ...
    print("Run the pipeline again to reattach this to YouTube_Master, or query "
          "youtube_classifications directly -- it is already the source of truth.")
    return 0

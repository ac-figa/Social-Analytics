...
MASTER_TABLE = "tiktok_master"
STAGING_TABLE = "tiktok_master_staging"
CLASSIFICATIONS_TABLE = "tiktok_classifications"
HISTORY_TABLE = "tiktok_insights_history"
HISTORY_STAGING_TABLE = "tiktok_insights_history_staging"
...
def insert_history_snapshot(client: bigquery.Client, rows: list, snapshot_date: str) -> None:
    ...
    WHEN NOT MATCHED THEN INSERT (Snapshot_Date, Video_ID, Views, Likes, Comments, Shares)
      VALUES (S.Snapshot_Date, S.Video_ID, S.Views, S.Likes, S.Comments, S.Shares)
    """
    client.query(merge_sql).result()
